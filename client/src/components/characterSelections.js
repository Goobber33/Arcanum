...
import character4 from '../images/Elysia.png';
import character5 from '../images/Elara.png';
import character6 from '../images/Finnian.png';
import character7 from '../images/Griffin.png';
import character8 from '../images/Tarik.png';
    ...
    return (
        ...
        >
                ...
                <Row>
                    <Col>
                        <div style={charactersContainerStyle}>
                            {characters.slice(startIndex, endIndex).map((character, index) => (
                                <motion.div
                                    key={index}
                                    whileHover={{ scale: 1.1 }}
                                    onMouseEnter={(event) => handleMouseEnter(startIndex + index, event)}
                                    ...
                                    style={showSwordIndex === startIndex + index ? { ...cardStyle, zIndex: 2 } : cardStyle}
                                >
                                    <img
                                        src={character}
            ...
            <div style={swordContainerStyle}>
                <img src={swordImage} alt="Sword" style={swordImageStyle} className="arrow-down-one" />
            </div>
        </motion.div>
    );
};
